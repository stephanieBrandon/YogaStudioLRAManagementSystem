...
namespace YogaStudioLRAManagementSystem.Migrations
{
    ...
    [Migration("20260401232527_AddMustChangePasswordToUsersAndSeedDataToUserEmployee")]
    partial class AddMustChangePasswordToUsersAndSeedDataToUserEmployee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YogaStudioLRAManagementSystem.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAELuKNL/FFk+4QEBFAMVlIVdLgHU48pX2ZPOfNiNOjEoIyztm+HqID88zM/e4xyeDjw==",
                            Role = "Admin",
                            UserName = "admin"
                        });
                });
